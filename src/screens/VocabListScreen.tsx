...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 12, color: colors.textTertiary, textAlign: 'center', marginTop: 2 },
  ...
  word: { fontSize: 20, fontWeight: '800', color: colors.text },
  ...
  pronunciation: { fontSize: 13, color: colors.primary, fontStyle: 'italic' },
  korean: { fontSize: 18, fontWeight: '700', color: colors.text },
  meaning: { fontSize: 14, color: colors.textSecondary, lineHeight: 20 },
  songName: { fontSize: 12, color: colors.textTertiary, marginTop: 4 },
